...
import com.example.ylearn.databinding.MyChatBinding
import com.example.ylearn.databinding.OtherChatBinding
...
class ChatsAdapter(var chatsList: ArrayList<ChatModel>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
